...
import com.vaadin.tatu.backend.ProductRepository;
import com.vaadin.tatu.backend.UserRepository;
...
public class DataGenerator implements HasLogger {
    ...
    private static final String[] FILLING = new String[] { "Strawberry",
            "Chocolate", "Blueberry", "Raspberry", "Vanilla" };
    ...
    private List<HistoryItem> createOrderHistory(Order order) {
        ...
        if (order.getState() == OrderState.CANCELLED) {
            ...
            item.setTimestamp(
                    orderPlaced.plusDays(random.nextInt((int) orderPlaced.until(
