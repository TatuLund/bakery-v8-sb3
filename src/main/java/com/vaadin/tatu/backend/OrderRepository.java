...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @EntityGraph(value = "Order.gridData", type = EntityGraphType.LOAD)
    Page<Order> findByCustomerFullNameContainingIgnoreCase(String searchQuery,
            Pageable pageable);

    @EntityGraph(value = "Order.gridData", type = EntityGraphType.LOAD)
    Page<Order> findByCustomerFullNameContainingIgnoreCaseAndDueDateAfter(
            String searchQuery, LocalDate dueDate, Pageable pageable);
    ...
    long countByCustomerFullNameContainingIgnoreCaseAndDueDateAfter(
            String searchQuery, LocalDate dueDate);
