package com.vaadin.tatu.ui.navigation;
...
import com.vaadin.tatu.app.security.SecurityUtils;
...
public class NavigationManager extends SpringNavigator {
    ...
    public void navigateToDefaultView() {
        ...
        navigateTo(SecurityUtils.isCurrentUserInRole(Role.ADMIN)
                ? DashboardView.class
    ...
    public void updateViewParameter(String parameter) {
        ...
        updateNavigationState(new ViewChangeEvent(this, getCurrentView(),
                getCurrentView(), viewName, parameters));
    }
