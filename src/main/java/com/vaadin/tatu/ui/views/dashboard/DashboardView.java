package com.vaadin.tatu.ui.views.dashboard;
...
import com.vaadin.tatu.backend.service.OrderService;
import com.vaadin.tatu.ui.components.OrdersGrid;
import com.vaadin.tatu.ui.navigation.NavigationManager;
import com.vaadin.tatu.ui.views.orderedit.OrderEditView;
...
public class DashboardView extends DashboardViewDesign implements View {
    ...
    private CompletableFuture<DashboardData> fetchDataAsync() {
        return CompletableFuture.supplyAsync(this::fetchData, executor);
    }
    ...
    private void updateGraphs(DashboardData data) {
        ...
        deliveriesThisMonthGraph.drawChart();
        deliveriesThisYearGraph.drawChart();
        yearlySalesGraph.drawChart();
        monthlyProductSplit.drawChart();
    }
